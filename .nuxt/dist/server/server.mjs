import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, defineComponent, provide, createElementBlock, isRef, isShallow, isReactive, openBlock, normalizeStyle, normalizeClass, createBlock, resolveDynamicComponent, mergeProps, withCtx, createTextVNode, toDisplayString, resolveComponent, createCommentVNode, createElementVNode, Fragment, toHandlers, withModifiers, TransitionGroup, renderSlot, renderList, createVNode, computed, Suspense, nextTick, Transition, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/attorneys-G5jwLtms.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-FHm3JSVm.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-gwOJK2IW.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C5cle3Zp.js").then((r) => r.default || r));
