  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        class: ""
      }, _attrs))} data-v-451c7a73><div style="${ssrRenderStyle({
        backgroundImage: `url(${unref(image)})`
      })}" class="flex w-full object-cover justify-center items-start h-auto py-20 lg:py-40" data-v-451c7a73><div class="bg-[#1F2732] container min-h-[349px] w-full p-4" data-v-451c7a73><div class="flex flex-col justify-between py-10 lg:px-40 gap-4" data-v-451c7a73><div class="flex lg:flex-row flex-col gap-4 w-full" data-v-451c7a73>`);
      ...
      _push(`</div><div class="flex lg:flex-row flex-col gap-4 w-full" data-v-451c7a73>`);
      _push(ssrRenderComponent(_component_UIInputAuthInput, {
        label: "Phone Number *",
      ...
      _push(`</div><div class="w-full font-light font-Satoshi400 text-[18px] outline-none bg-transparent text-[#D7D7D7] border-b-[#3A4553] !py-2 border-b-[1px] opacity-[0.8029] text-sm" data-v-451c7a73>`);
      ...
      _push(`</div><div class="flex justify-center" data-v-451c7a73>`);
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-451c7a73"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-D7gI3JDL.mjs.map
