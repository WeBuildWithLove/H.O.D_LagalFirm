import { hasInjectionContext, inject, version, unref, defineComponent, ref, provide, createElementBlock, getCurrentInstance, h, computed, shallowReactive, watch, Suspense, nextTick, Transition, toRaw, openBlock, normalizeStyle, normalizeClass, createBlock, resolveDynamicComponent, mergeProps, withCtx, createTextVNode, toDisplayString, resolveComponent, createCommentVNode, createElementVNode, Fragment, toHandlers, withModifiers, TransitionGroup, renderSlot, renderList, createVNode, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, toRef, shallowRef, isReadonly, markRaw, isRef, isShallow, isReactive, defineAsyncComponent } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./attorneys-G5jwLtms.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-FHm3JSVm.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-gwOJK2IW.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRouter as a, useToast as b, useRuntimeConfig as c, navigateTo as d, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRoute as u };
